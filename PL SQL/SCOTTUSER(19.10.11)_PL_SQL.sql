...
DECLARE
    ...
    vempsal emp.sal%TYPE;
    vehiredate emp.hiredate%TYPE;
BEGIN
...
BEGIN
    ...
    INSERT INTO emp_copy(ename, sal, hiredate, empno, mgr, job, deptno, comm) VALUES('OLIVIA', 2800, SYSDATE, emp_empno, 7788, 'SALESMAN', 10, 0);
END;
/
